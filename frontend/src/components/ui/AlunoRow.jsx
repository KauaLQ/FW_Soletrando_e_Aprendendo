...
export default function AlunoRow({ aluno, indice = 0, onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 bg-white border border-ink/10 rounded-2xl p-3.5 text-left hover:border-marker/40 hover:shadow-md hover:shadow-ink/5 active:scale-[0.99] transition"
    >
